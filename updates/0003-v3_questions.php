...
<input type=\"submit\" name=\"op\" value=\"Save Answers\">' ),
 ( 3, 16, 1, 2, 8, 0, '<b>Subgroup(s), with 10 or more members, which had less than [[SELECT [answer_0] FROM answer CROSS JOIN question USING (questionid) WHERE csipid = [csipid] AND categoryid = [categoryid] AND part = 1 AND version = 3 AND order_num = 2]]% proficient</b>
