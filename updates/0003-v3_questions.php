...
[input_1]' ),
 ( 3, 16, 2, 8, 'Which subgroup(s), with 10 or more members, had less than [[SELECT [answer_0] FROM answer CROSS JOIN question USING (questionid) WHERE csipid = [csipid] AND categoryid = [categoryid] AND part = 1 AND version = 2 AND order_num = 1]]% proficient?
