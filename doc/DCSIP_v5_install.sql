...
For middle and high school only-Utilize the elements of this section to support the necessary accreditation expectations and highlight the work that your school is engaged in..'),
  ( 7, 2, 2, 1, 0, '<p>Demographics
[input]</p>'),
  ( 7, 2, 3, 1, 0, '<p>Learning Data
[input]</p>'),
  ( 7, 2, 4, 1, 0, '<p>Survey Results
[input]</p>'),
  ( 7, 2, 5, 1, 0, '<p>IEQ-Index of Education Equality
[input]</p>'),
  ( 7, 2, 6, 1, 0, '<p>Learning Environment
[input]</p>'),
