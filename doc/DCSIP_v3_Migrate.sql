...
INSERT INTO csip_v5.course_question_links (courseid,question_group,part) (SELECT courseid,1,1 FROM course);
INSERT INTO csip_v5.course_question_links (courseid,question_group,part) (SELECT courseid,2,2 FROM course);
INSERT INTO csip_v5.course_question_links (courseid,question_group,part) (SELECT courseid,2,2 FROM course);
