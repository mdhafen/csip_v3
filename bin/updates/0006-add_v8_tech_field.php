...
if ( $row['count'] == 0 ) {
  ...
  $sth->bindValue(':quest','<p><strong>Leadership Team Technology Plan:</strong></p><hr><p>After completing your Team PGP, connect your leadership team\'s plan for <strong>achieving current learning goals</strong> through: <ul><li>effective use of digital tools and resources,</li><li>leadership and coaching practices that support teaching and learning,</li><li>leadership observation and monitoring of teachers\' progress,</li><li>and purchases that support your school\'s learning goals.</li></ul>Note areas where the Digital Teaching and Learning Team can <strong>help your Sailboat teachers achieve the school\'s current learning goals</strong>.</p><p>(<a href="https://washk12.learning.powerschool.com/tony.campbell/sltp/cms_page/view" target="_blank">Click here for optional technology template</a>)</p>');
  $sth->execute();
