                ...
                <form class="uk-form uk-form-horizontal" action="save_answer.php">
                    ...
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            ...
                            <textarea id="form-h-t" cols="50" rows="8" name="answers[]" placeholder="Textarea text"><?= isset($questions[14]['answer']) ? $questions[14]['answer'] : "" ?></textarea>
                        </div>
                    </div>     
                    <hr>
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            ...
                            <input type="text" id="form-h-it" name="answers[]" value="<?= isset($questions[15]['answer']) ? $questions[15]['answer'] : "" ?>" placeholder="Text input">
                        </div>
                    </div>
                    <hr>                                              
                    <div class="uk-form-row">
                    ...
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            ...
                            <textarea id="form-h-t" cols="50" rows="8" name="answers[]" placeholder="Textarea text"><?= isset($questions[17]['answer']) ? $questions[17]['answer'] : "" ?></textarea>
                        </div>
                    </div>
                    <br>
                ...
                <form class="uk-form uk-form-horizontal" action="save_answer.php">
                    ...
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            ...
                            <textarea id="form-h-t" cols="50" rows="8" name="answers[]" placeholder="Textarea text"><?= isset($questions[20]['answer']) ? $questions[20]['answer'] : "" ?></textarea>
                        </div>
                    </div>     
                    <hr>                                              
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            ...
                            <input type="text" id="form-h-it" name="answers[]" value="<?= isset($questions[21]['answer']) ? $questions[21]['answer'] : "" ?>" placeholder="Text input">
                        </div>
                    </div>
                    <hr>                                              
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            ...
                            <textarea id="form-h-t" cols="50" rows="8" name="answers[]" placeholder="Textarea text"><?= isset($questions[22]['answer']) ? $questions[22]['answer'] : "" ?></textarea>
                        </div>
                    </div>
                    <hr>
                    <div class="uk-form-row">
            ...
            <form class="uk-form uk-form-horizontal" action="save_answer.php">
                    ...
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            ...
                            <textarea id="form-h-t" cols="50" rows="8" name="answers[]" placeholder="Textarea text"><?= isset($questions[26]['answer']) ? $questions[26]['answer'] : "" ?></textarea>
                        </div>
                    </div>     
                    <hr>                                              
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            ...
                            <input type="text" id="form-h-it" name="answers[]" value="<?= isset($questions[27]['answer']) ? $questions[27]['answer'] : "" ?>" placeholder="Text input">
                        </div>
                    </div>
                    <hr>                                              
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            ...
                            <textarea id="form-h-t" cols="50" rows="8" name="answers[]" placeholder="Textarea text"><?= isset($questions[28]['answer']) ? $questions[28]['answer'] : "" ?></textarea>
                        </div>
                    </div>
    <br>
<button class="uk-button uk-button-success uk-align-right" type="button" onclick="this.form.submit()">Save</button>
