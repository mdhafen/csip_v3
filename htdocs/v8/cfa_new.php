    ...
    <li id="cfal<?= $part ?>" class="uk-parent" aria-expanded="true">
        ...
        <div class="uk-form-row uk-panel uk-panel-box">
            ...
            <div class="uk-form-controls">
                ...
                <textarea id="cfa-l-<?= $part ?>-45" cols="50" rows="8" name="answers[]" placeholder="text input"></textarea>
            </div>
        </div>
        <br>
    </li>
        ...
        <div class="uk-panel uk-panel-box">
            ...
            <div class="uk-form-row">
                ...
                <div class="uk-form-controls">
                    ...
                    <input type="hidden" name="sequences[]" value="0">
                    <textarea id="cfa-c-<?= $part ?>-48" cols="50" rows="8" name="answers[]" placeholder="text input"></textarea>
                </div>
            </div>
            <hr>
            <div class="uk-form-row uk-grid">
                <div class="uk-width-1-2">
                    ...
                    <div class="uk-form-controls">
                        ...
                        <input type="hidden" name="sequences[]" value="0">
                        <textarea id="cfa-c-<?= $part ?>-49" cols="25" rows="8" name="answers[]" placeholder="text input"></textarea>
                    </div>
                </div>
                ...
                <div class="uk-width-1-2">
                    ...
                    <div class="uk-form-controls">
                        ...
                        <input type="hidden" name="sequences[]" value="0">
                        <textarea id="cfa-c-<?= $part ?>-50" cols="25" rows="8" name="answers[]" placeholder="text input"></textarea>
                    </div>
                </div>
            </div>
            <hr>
            <div class="uk-form-row">
                ...
                <div class="uk-form-controls">
                    ...
                    <input type="hidden" name="sequences[]" value="0">
                    <textarea id="cfa-c-<?= $part ?>-51" cols="50" rows="8" name="answers[]" placeholder="text input"></textarea>
                </div>
            </div>
            <hr>
            <div class="uk-form-row">
            ...
            <div class="uk-panel uk-panel-box">
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                        ...
                        <input type="hidden" name="sequences[]" value="0">
                        <textarea id="cfa-i-<?= $part ?>-55" cols="50" rows="8" name="answers[]" placeholder="text input"></textarea>
                    </div>
                </div>
                <hr>
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                        ...
                        <input type="hidden" name="sequences[]" value="0">
                        <input type="text" id="cfa-i-<?= $part ?>-56" name="answers[]" value="" placeholder="text input">
                    </div>
                </div>
                <hr>
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                        ...
                        <input type="hidden" name="sequences[]" value="0">
                        <textarea id="cfa-i-<?= $part ?>-57" cols="50" rows="8" name="answers[]" placeholder="text input"></textarea>
                    </div>
                </div>
                <hr>
                <div class="uk-form-row">
            ...
            <div class="uk-panel uk-panel-box">
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                        ...
                        <input type="hidden" name="sequences[]" value="0">
                        <textarea id="cfa-l-<?= $part ?>-61" cols="50" rows="8" name="answers[]" placeholder="text input"></textarea>
                    </div>
                </div>
                <hr>
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                        ...
                        <input type="hidden" name="sequences[]" value="0">
                        <input type="text" id="cfa-l-<?= $part ?>-62" name="answers[]" value="" placeholder="text input">
                    </div>
                </div>
                <hr>
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                        ...
                        <input type="hidden" name="sequences[]" value="0">
                        <textarea id="cfa-l-<?= $part ?>-29" cols="50" rows="8" name="answers[]" placeholder="text input"></textarea>
                    </div>
                </div>
                <br>
  <?php if ( !empty($data['can_edit']) ) { ?>
