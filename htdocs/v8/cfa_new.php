            ...
            <div class="uk-form-row uk-flex uk-flex-wrap uk-margin-top">
                <div class="uk-flex-item-auto uk-margin-right" style="width: 45%">
                    ...
                    <span class="">
                        ...
                        <input type="hidden" name="sequences[]" value="0">
                        <textarea id="cfa-c-<?= $part ?>-48" cols="41" rows="8" name="answers[]" placeholder="text input"></textarea>
                    </span>
                </div>
                ...
                <div class="uk-flex-item-auto uk-margin-right" style="width: 20%">
                    ...
                    <div class="">
                        ...
                        <input type="hidden" name="sequences[]" value="0">
                        <textarea id="cfa-c-<?= $part ?>-49" cols="15" rows="8" name="answers[]" placeholder="text input"></textarea>
                    </div>
                </div>
            ...
            <div class="uk-form-row uk-flex">
                <div class="uk-flex-item-auto uk-margin-right" style="">
                    ...
                    <div class="">
                        ...
                        <input type="hidden" name="sequences[]" value="0">
                        <textarea id="cfa-i-<?= $part ?>-55" cols="40" rows="8" name="answers[]" placeholder="text input"></textarea>
                    </div>
                </div>
                <div class="uk-flex-item-auto uk-margin-right" style="">
