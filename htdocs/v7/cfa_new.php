            ...
            <li class="uk-panel uk-panel-box">
                    ...
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            ...
                            <textarea id="cfa-m-<?= $part ?>-15" cols="50" rows="8" name="answers[]" placeholder="text input"></textarea>
                        </div>
                    </div>
                    <hr>
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            ...
                            <input type="hidden" name="sequences[]" value="0">
                            <input type="text" id="cfa-m-<?= $part ?>-16" name="answers[]" value="" placeholder="text input">
                        </div>
                    </div>
                    <hr>
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            ...
                            <input type="hidden" name="sequences[]" value="0">
                            <input type="text" id="cfa-m-<?= $part ?>-17" name="answers[]" value="" placeholder="text input">
                        </div>
                    </div>
                    <hr>
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            ...
                            <input type="hidden" name="sequences[]" value="0">
                            <textarea id="cfa-m-<?= $part ?>-18" cols="50" rows="8" name="answers[]" placeholder="text input"></textarea>
                        </div>
                    </div>
                    <br>
        ...
        <ul class="uk-nav-sub">
            ...
            <li class="uk-panel uk-panel-box">
                    ...
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            ...
                            <input type="hidden" name="sequences[]" value="0">
                            <textarea id="cfa-i-<?= $part ?>-21" cols="50" rows="8" name="answers[]" placeholder="text input"></textarea>
                        </div>
                    </div>
                    <hr>
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            ...
                            <input type="hidden" name="sequences[]" value="0">
                            <input type="text" id="cfa-i-<?= $part ?>-22" name="answers[]" value="" placeholder="text input">
                        </div>
                    </div>
                    <hr>
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            ...
                            <input type="hidden" name="sequences[]" value="0">
                            <textarea id="cfa-i-<?= $part ?>-23" cols="50" rows="8" name="answers[]" placeholder="text input"></textarea>
                        </div>
                    </div>
                    <hr>
                    <div class="uk-form-row">
			<label class="uk-form-label" for="cfa-i-<?= $part ?>-24">How did your TEAM respond to those who were still not proficient even after your team&apos;s interventions?</label>
                        <div class="uk-form-controls">
                            ...
                            <input type="hidden" name="sequences[]" value="0">
                            <textarea id="cfa-i-<?= $part ?>-24" cols="50" rows="8" name="answers[]" placeholder="text input"></textarea>
                        </div>
                    </div>
                    <br>
  <?php if ( !empty($data['can_edit']) ) { ?>
                ...
                <div class="uk-badge uk-badge-notification uk-align-right"><?= $count ?></div>
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            ...
                            <input type="hidden" name="sequences[]" value="0">
                            <textarea id="cfa-l-<?= $part ?>-27" cols="50" rows="8" name="answers[]" placeholder="text input"></textarea>
                        </div>
                    </div>
                    <hr>
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls">
                            ...
                            <input type="hidden" name="sequences[]" value="0">
                            <input type="text" id="cfa-l-<?= $part ?>-28" name="answers[]" value="" placeholder="text input">
                        </div>
                    </div>
                    <hr>
                    <div class="uk-form-row">
